...
public class Token {
  ...
  public Token(int type, int line, int col, Object value){
    this.type = type;
    this.lineValue = line;
    this.colValue = col;
    this.value = value;
  ...
  public String toString(){
    String str = (this.value == null) ? 
      String.format("<%s>", this.getTypeString()) :
      String.format("<%s, %s>", this.getTypeString(), this.value);
    return str;  
  }
